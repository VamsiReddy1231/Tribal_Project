...
const Homepage = () => {
  ...
  return (
    <div className="">
      ...
      <HomeProductSection data={mens_kurta} section={"Clothing"} />
        <HomeProductSection data={mensShoesPage1} section={"Tribal Painting"} />
        <HomeProductSection data={lengha_page1} section={"Organics and Spices"} />
